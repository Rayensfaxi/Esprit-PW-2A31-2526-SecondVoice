        ...
        <div class="topbar">
          <div>
            ...
            <div class="page-subtitle">
              Suivez vos demandes, vos rendez-vous et vos documents en un seul
              endroit.
            </div>
          </div>
          <div class="toolbar-actions">
            <a class="update-button" href="../front_office/index.php"
              >Revenir</a
            >
            <button
          ...
          <section class="hero-banner">
            <div class="hero-inner">
              <div class="hero-copy">
                ...
                <p>
                  Cet espace vous permet de suivre vos demandes, consulter vos
                  documents, gerer vos rendez-vous et demander un
                  accompagnement.
                </p>
          ...
          <section class="content-section">
            <div class="welcome-row">
              <div>
                ...
                <div class="helper">
                  Accedez a vos informations essentielles.
                </div>
              </div>
            </div>
              ...
              <article class="tool-card">
                <div class="tool-visual chat">
                  <img
                    ...
                    alt="Apercu des demandes"
                  />
                </div>
                <div class="mini-badge">Demandes</div>
                <h3 class="feature-title">Mes demandes</h3>
                <p class="card-copy">
                  Consultez et suivez l'etat de vos demandes administratives en
                  temps reel.
                </p>
              </article>
              <article class="tool-card">
                <div class="tool-visual image">
                  <img
                    ...
                    alt="Apercu des rendez-vous"
                  />
                </div>
                <div class="mini-badge">Rendez-vous</div>
                <h3 class="feature-title">Mes rendez-vous</h3>
                <p class="card-copy">
                  Planifiez et gerez vos rendez-vous avec les services
                  disponibles.
                </p>
              </article>
              <article class="tool-card">
                <div class="tool-visual voice">
                  <img
                    ...
                    alt="Apercu des documents"
                  />
                </div>
                <div class="mini-badge">Documents</div>
                <h3 class="feature-title">Mes documents</h3>
                <p class="card-copy">
                  Ajoutez, consultez et gerez vos documents lies a vos demandes.
                </p>
              </article>
            </div>
          </section>
