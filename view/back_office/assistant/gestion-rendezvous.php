        ...
        <div class="sidebar-panel">
          ...
          <div class="sidebar-scroll">
            <div class="nav-section">
              ...
              <a
                class="nav-link"
                href="gestion-demandes.php"
                data-nav="community"
                ><span class="nav-icon icon-community"></span
                ><span>Gestion des demandes</span></a
              >
              <a
                class="nav-link"
              ...
              <a
                ...
                ><span>Gestion des accompagnements</span></a
              >
              <a
                class="nav-link"
                href="gestion-documents.php"
                data-nav="images"
                ><span class="nav-icon icon-image"></span
                ><span>Gestion des documents</span></a
              >
              <a
                class="nav-link"
                ...
                ><span>Gestion des reclamations</span></a
              >
            ...
            <div class="profile-menu-wrap" data-profile-wrap>
              ...
              <div class="profile-dropdown" data-profile-menu>
                ...
                <div class="profile-menu-list">
                  <a class="menu-link" href="gestion-utilisateurs.php"
                  ...
                  <a class="menu-link" href="settings.php"
                    ...
                    ><span>Parametres</span></a
                  >
                  <a class="menu-link" href="gestion-rendezvous.php"
                    ><span class="menu-icon icon-card"></span
                    ><span>Gestion des rendez-vous</span></a
                  >
                  <a class="menu-link" href="gestion-demandes.php"
                    ><span class="menu-icon icon-activity"></span
                    ><span>Gestion des demandes</span></a
                  >
                  <a class="menu-link" href="gestion-accompagnements.php"
          ...
          <section class="hero-banner">
            <div class="hero-inner">
              <div class="hero-copy">
                ...
                <p>Planifiez et confirmez les rendez-vous avec les usagers.</p>
                <a class="cta-button" href="gestion-rendezvous.php"
              ...
              <div class="hero-visual">
                <div class="device-stack">
                  <img
                    class="hero-art"
                    src="../../assets/media/hero-collage.svg"
                    alt="IntellectAI creator studio collage"
                  />
                </div>
              </div>
            </div>
          ...
          <section class="content-section">
            <div class="welcome-row">
              ...
              <div>
                ...
                <div class="helper">
                  Your most used creation tools are pinned below.
                </div>
              </div>
            </div>
            ...
            <div class="card-grid">
              <article class="tool-card">
                <div class="tool-visual chat">
                  <img
                    src="../../assets/media/preview-chat.svg"
                    alt="AI chat workspace preview"
                  />
                </div>
                <div class="mini-badge">AI Chat</div>
                <h3 class="feature-title">AI assistant workspace</h3>
                <p class="card-copy">
                  Draft captions, product descriptions, and customer responses
                  with reusable prompt blocks.
                </p>
              </article>
              <article class="tool-card">
                <div class="tool-visual image">
                  <img
                    src="../../assets/media/preview-image.svg"
                    alt="Image generator preview"
                  />
                </div>
                <div class="mini-badge">Image Lab</div>
                <h3 class="feature-title">Generate campaign visuals</h3>
                <p class="card-copy">
                  Build prompt sets, choose ratios, and review image batches
                  from the same control panel.
                </p>
              </article>
              <article class="tool-card">
                <div class="tool-visual voice">
                  <img
                    src="../../assets/media/preview-voice.svg"
                    alt="Voice generation preview"
                  />
                </div>
                <div class="mini-badge">Voice Mix</div>
                <h3 class="feature-title">Create voice-ready scripts</h3>
                <p class="card-copy">
                  Tune language, pace, and tone for social clips, explainers,
                  and onboarding audio.
                </p>
              </article>
            </div>
          </section>
            ...
            <article class="panel">
              ...
              <div class="feed-list">
                <div class="feed-item">
                  ...
                  <div class="feed-meta">
                    <span>Gestion des documents</span><span>9 min ago</span>
                  </div>
                </div>
                <div class="feed-item">
                  <strong>Voice preset exported</strong>
                  <div class="feed-meta">
                    <span>Gestion des reclamations</span><span>24 min ago</span>
                  </div>
                </div>
                <div class="feed-item">
                  <strong>Subscription upgraded to Pro</strong>
                  <div class="feed-meta">
                    <span>Gestion des rendez-vous</span><span>1 hour ago</span>
                  </div>
                </div>
              </div>
            </article>
