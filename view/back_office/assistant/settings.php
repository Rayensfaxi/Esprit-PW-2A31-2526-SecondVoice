...
<html lang="en">
  <head>
    ...
    <title>IntellectAI | Settings</title>
        ...
        <div class="topbar">
          <div>
            ...
            <div class="page-subtitle">
              Control workspace defaults, notifications, and profile behavior.
            </div>
          </div>
          <div class="toolbar-actions">
            <a
              class="update-button"
              href="../../front_office/index.php"
              >Revenir</a
            >
            <button
          ...
          <article class="form-card">
            <div class="card-header">
              <div>
                ...
                <h3 class="panel-title">Workspace details</h3>
              </div>
            </div>
            <div class="form-grid">
              <div class="control-box">
                <div class="control-label">Workspace name</div>
                <input type="text" value="IntellectAI Studio" />
              </div>
              <div class="control-box">
                <div class="control-label">Domain</div>
                <input type="text" value="studio.intellectai.com" />
              </div>
              <div class="control-box">
                <div class="control-label">Default language</div>
                <select>
              ...
              <div class="control-box full">
                ...
                <textarea>
Creator dashboard for AI chat, image generation, subscription management, and voice publishing.</textarea
                >
              </div>
            </div>
            <div
              class="toolbar-actions"
              style="margin-top: 18px; justify-content: flex-start"
            >
          ...
          <article class="panel">
            <div class="panel-header">
              <div>
                <div class="small-label">Preferences</div>
            ...
            <div class="settings-list">
              <div class="setting-row">
                <div class="list-row">
                  <div>
                    ...
                    <div class="helper">
                      Receive alerts for new renders and billing events.
                    </div>
                  </div>
              ...
              <div class="setting-row">
                <div class="list-row">
                  <div>
                    <strong>Auto-save prompts</strong>
                    <div class="helper">
                      Save every generated prompt to your workspace.
                    </div>
                  </div>
                  <div class="toggle on"></div>
                </div>
              ...
              <div class="setting-row">
                <div class="list-row">
                  <div>
                    <strong>Community moderation mode</strong>
                    <div class="helper">
                      Require approval for new public prompt sets.
                    </div>
                  </div>
              ...
              <div class="setting-row">
                <div class="list-row">
                  <div>
                    <strong>Night reminders</strong>
                    <div class="helper">
                      Send publishing reminders after 9 PM local time.
                    </div>
                  </div>
                  <div class="toggle"></div>
                </div>
