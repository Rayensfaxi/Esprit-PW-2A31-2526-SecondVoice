          ...
          <div class="container">
            <div class="page-hero-card fade-up">
              <div class="breadcrumbs">
                <span>Accueil</span><span>/</span><span>A propos</span>
              </div>
              <h1>A propos de SecondVoice</h1>
              <p>
                SecondVoice est une plateforme qui aide les utilisateurs a gerer
                leurs demandes administratives et leurs interactions de service
                plus simplement.
              </p>
            </div>
          </div>
          ...
          <div class="container grid-2">
            <article class="image-card fade-up">
              <div class="image-card-content">
                ...
                <h3>
                  SecondVoice centralise les besoins administratifs dans une
                  experience claire.
                </h3>
                <p>
                  L'utilisateur peut soumettre une demande, suivre son
                  traitement, recevoir des rappels et obtenir de l'aide sans
            ...
            <div class="fade-up">
              ...
              <h2>
                Rendre les demarches plus rapides, plus accessibles et mieux
                suivies.
              </h2>
              <p class="section-copy">
                SecondVoice reduit la charge administrative, ameliore la
                communication avec les services et limite les retards lies au
              ...
              <ul class="feature-list">
                ...
                <li>
                  Historique centralise pour eviter les pertes d'information
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="container">
            ...
            <div class="grid-3">
              <article class="info-card fade-up">
                ...
                <h3>Description</h3>
                <p>
                  Une application orientee usager pour simplifier les echanges
                  administratifs.
                </p>
              </article>
              <article class="info-card fade-up">
                ...
                <h3>Objectif</h3>
                <p>
                  Faire gagner du temps aux utilisateurs et aux equipes de
                  support.
                </p>
              </article>
              <article class="info-card fade-up">
                ...
                <p>
                  Moins de confusion, moins de retard, et un parcours de demande
                  plus fluide.
                </p>
              </article>
            </div>
            ...
            <div class="achievement fade-up">
              <div class="grid-4">
                <div>
                  ...
                  <div class="meta">
                    specialistes en strategie, livraison et conception
                    d'experience
                  </div>
                </div>
                <div>
                  ...
                  <div class="meta">
                    missions de modernisation realisees dans des secteurs
                    reglementes
                  </div>
                </div>
                <div>
                  ...
                  <div class="meta">
                    des projets lances avec des systemes de contenu
                    reutilisables
                  </div>
                </div>
                <div>
                  ...
                  <div class="meta">
                    de satisfaction client sur les partenariats long terme
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="grid-4">
              <article class="team-card fade-up">
                ...
                <div class="team-socials">
                  <a href="#">in</a><a href="#">x</a><a href="#">be</a>
                </div>
              </article>
              <article class="team-card fade-up">
                <div class="team-art"></div>
        ...
        <div class="container">
          <div class="footer-main">
            <div>
              ...
              /></a>
              <p>
                Template HTML premium pour agences IA, cabinets technologiques
                et marques orientees cyber.
              </p>
            </div>
            <div>
