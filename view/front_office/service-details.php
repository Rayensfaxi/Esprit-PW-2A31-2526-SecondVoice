...
<html lang="fr">
  <head>
    ...
    <title>Detail du service | SecondVoice</title>
    <link
      rel="icon"
      type="image/png"
      sizes="32x32"
        ...
        <section class="page-hero">
          <div class="container">
            <div class="page-hero-card fade-up">
              ...
              <h1>
                Automatisation IA des flux de travail pour des equipes de
                service a fort volume.
              </h1>
              <p>
                Un modele de page detail pour expliquer la methode, les
                livrables, les resultats et l'adequation projet.
              </p>
            </div>
          </div>
        </section>
            ...
            <div class="post-content fade-up">
              <div class="post-hero">
                <div class="post-hero-content">
                  ...
                  <h2>
                    Automatisez l'intake, l'orientation et l'intelligence
                    support avec des couches IA maitrisees.
                  </h2>
                  <p>
                    Cet exemple de service convient aux cabinets de conseil et
                    aux studios numeriques qui proposent la conception de flux
                    de travail, l'organisation de la connaissance et la
              ...
              <p>
                Nous aidons les equipes a reduire le travail manuel repetitif en
                cartographiant les etapes operationnelles, en identifiant les
                points ou l'IA apporte de la valeur et en mettant en place des
                controles de flux qui maintiennent un haut niveau de qualite.
              </p>
              <h3>Livrables typiques</h3>
              <ul class="feature-list">
                <li>
                  Cartographies de flux de travail et logiques d'exception
                </li>
                <li>Frameworks de prompts et d'instructions</li>
                <li>Structure d'ingestion de base de connaissances</li>
                <li>Revue qualite et chemins d'escalade</li>
              </ul>
              <h3>Pourquoi cette page convainc les acheteurs</h3>
              <p>
                Une page detail solide reduit l'ambiguite. Elle montre comment
                le travail est realise, ce qui est inclus et ou l'impact metier
                apparait.
              </p>
            </div>
            <aside class="sidebar">
              ...
              <div class="sidebar-card fade-up">
                ...
                <p>
                  Adaptez le contenu a des offres cloud, securite, analytics ou
                  conception produit.
                </p>
                <a class="btn btn-primary" href="contact.php"
                  >Demander une version personnalisee</a
                >
              </div>
            </aside>
          </div>
