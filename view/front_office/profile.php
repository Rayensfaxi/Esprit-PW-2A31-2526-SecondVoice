          ...
          <div class="container">
            <div class="page-hero-card fade-up">
              <div class="breadcrumbs">
                <span>Accueil</span><span>/</span><span>Profil</span>
              </div>
              <h1>Completez votre profil</h1>
              <p>
                Ajoutez votre photo et vos informations personnelles pour
                personnaliser votre espace SecondVoice.
              </p>
            </div>
          </div>
        </section>
        ...
        <section class="section">
          <div class="container profile-grid">
            <article class="contact-card fade-up">
              ...
              <p>
                Mettez a jour vos informations. Les changements sont enregistres
              ...
              <form id="profile-form" class="profile-form">
                <div class="profile-photo-row">
                  <div class="profile-photo-preview" id="profile-photo-preview">
                    <span id="profile-photo-initials">GU</span>
                  </div>
                  <div class="profile-photo-actions">
                    <label class="btn btn-secondary" for="profile-photo-input"
                      >Ajouter une photo de profil</label
                    >
                    <button
                      class="btn btn-secondary"
                      id="profile-photo-clear"
                      type="button"
                    >
                      Supprimer la photo
                    </button>
                    <p class="profile-help">
                      Formats acceptes : JPG/PNG, max 4 Mo.
                    </p>
                  </div>
                </div>
            ...
            <aside class="sidebar">
              <div class="sidebar-card fade-up">
                <h3 id="profile-summary-name">Utilisateur invite</h3>
                <p id="profile-summary-email">utilisateur@exemple.com</p>
                <p class="profile-help">
                  Votre profil est utilise pour personnaliser votre experience
                  sur l'interface.
                </p>
              </div>
        ...
        <div class="container">
          <div class="footer-bottom">
            ...
            <div class="footer-links">
              <a href="index.php">Accueil</a><a href="contact.php">Support</a>
            </div>
          </div>
        </div>
      </footer>
