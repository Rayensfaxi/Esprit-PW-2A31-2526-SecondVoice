          ...
          <div class="container">
            <div class="page-hero-card fade-up">
              <div class="breadcrumbs">
                <span>Accueil</span><span>/</span><span>Blog</span>
              </div>
              <h1>Blog SecondVoice</h1>
              <p>
                Conseils, actualites et guides pour mieux gerer vos demarches et
                votre suivi.
              </p>
            </div>
          </div>
          ...
          <div class="container blog-layout">
            <div class="post-grid">
              <article class="blog-card fade-up">
                ...
                <div class="post-meta">
                  <span class="tag">Conseils</span><span>23 Mar 2026</span>
                </div>
                <h3>
                  <a href="blog-details.php"
                    >5 conseils pour accelerer vos demandes administratives</a
                  >
                </h3>
                <p>
                  Des bonnes pratiques simples pour eviter les erreurs
                  frequentes et gagner du temps.
                </p>
              </article>
              <article class="blog-card fade-up">
                <div class="blog-art"></div>
                <div class="post-meta">
                  <span class="tag">Actualites</span><span>19 Mar 2026</span>
                </div>
                <h3>
                  <a href="blog-details.php"
                    >Nouveautes SecondVoice: suivi plus clair des statuts</a
                  >
                </h3>
                <p>
                  Un point rapide sur les dernieres ameliorations cote
              ...
              <article class="blog-card fade-up">
                <div class="blog-art"></div>
                <div class="post-meta">
                  <span class="tag">Guides</span><span>14 Mar 2026</span>
                </div>
                <h3>
                  <a href="blog-details.php"
                    >Guide pratique: prise de rendez-vous en 3 etapes</a
                  >
                </h3>
                <p>
                  Un tutoriel rapide pour reserver, confirmer et suivre un
                  rendez-vous efficacement.
                </p>
              </article>
            </div>
            <aside class="sidebar">
        ...
        <div class="container">
          <div class="footer-bottom">
            ...
            <div class="footer-links">
              <a href="blog-details.php">Article a la une</a
