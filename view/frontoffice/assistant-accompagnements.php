...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($action === 'add_guide' && $goal_id) {
            ...
            if ($title === '' || $content === '') {
              redirect_with_notice('assistant-accompagnements.php', 'error', "Veuillez remplir le titre et le contenu de l'�tape.");
            } else {
                $guide = new Guide($goal_id, $title, $content);
                if ($guideCtrl->createGuideByAssistant($guide, $assistant_id)) {
                redirect_with_notice('assistant-accompagnements.php', 'success', "�tape ajout�e au guide avec succ�s.");
                } else {
                redirect_with_notice('assistant-accompagnements.php', 'error', "Vous n'�tes pas autoris� � ajouter une �tape � cet accompagnement.");
                }
            }
        }
  ...
  <body data-page="chatbot">
    <div class="shell">
      <aside class="sidebar">
        <div class="sidebar-panel">
          <div class="brand-row">
            <a class="brand" href="index.php"><img class="brand-logo" src="../backoffice/assets/media/secondvoice-logo.png" alt="SecondVoice logo" /></a>
          </div>
      ...
      <main class="page">
        ...
        <div class="page-grid">
          <section class="content-section">
            ...
            <?php if (empty($goals)): ?>
              <div class="panel">
                <p>Aucune demande transf�r�e pour le moment. D�s qu'un admin valide une demande, elle appara�tra ici.</p>
              </div>
            <?php else: ?>
                ...
                <div class="mission-card">
                  ...
                  <?php if ($g['assistant_validation_status'] == 'en_attente'): ?>
                    <form method="POST" class="panel">
                      ...
                      <label for="priority-<?= (int)$g['id'] ?>"><strong>Priorit�</strong></label>
                      <select id="priority-<?= (int)$g['id'] ?>" name="priority" class="form-control" required>
                        <option value="basse">Basse</option>
                        <option value="moyenne" selected>Moyenne</option>
                        <option value="haute">Haute</option>
                      </select>
                      <label for="status-<?= (int)$g['id'] ?>"><strong>�tat</strong></label>
                      ...
                      <button type="submit" name="decision" value="refuse"  class="btn btn-danger"  onclick="return confirm('Refuser cette demande ? Elle sera supprim�e.');">Refuser</button>
                    </form>
                  <?php endif; ?>
                    ...
                    <div class="guide-list panel">
                      ...
                      ?>
                        <div class="guide-item">
                          ...
                          <div style="position: absolute; top: 10px; right: 10px; display:flex; gap: 5px;">
                            ...
                            <form method="POST" style="margin: 0;" class="js-confirm-delete" data-confirm-message="Supprimer cette �tape ? Cette action est d�finitive.">
                      ...
                      <?php if ($g['status'] == 'en_cours'): ?>
                        <form method="POST" class="panel" style="margin-top: 15px;">
                          <h5>Ajouter une �tape</h5>
                          <input type="hidden" name="action"  value="add_guide">
                          <input type="hidden" name="goal_id" value="<?= (int)$g['id'] ?>">
                          <input type="text" name="title" class="form-control" placeholder="Titre de l'�tape" required>
                          <textarea name="content" class="form-control" rows="3" placeholder="Contenu et actions � r�aliser..." required></textarea>
                          <button class="btn btn-primary" type="submit">Enregistrer l'�tape</button>
                        </form>

                        <form method="POST" style="margin-top: 15px; text-align: right;" onsubmit="return confirm('Marquer cet accompagnement comme termin� ?');">
    ...
    <div id="confirmOverlay" class="confirm-overlay" aria-hidden="true">
      <div class="confirm-modal" role="dialog" aria-modal="true" aria-labelledby="confirmTitle">
        ...
        <p id="confirmText" class="confirm-text">Cette action est d�finitive.</p>
