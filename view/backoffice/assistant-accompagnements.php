                ...
                <div class="mission-card">
                  ...
                  <?php if ($g['assistant_validation_status'] == 'en_attente'): ?>
                    <form method="POST" class="panel">
                      ...
                      <button type="submit" name="decision" value="refuse" class="btn btn-danger"
                              data-confirm="La demande sera refusée et définitivement supprimée."
                    ...
                    <div class="guide-list panel">
                      ...
                      <?php if ($g['status'] == 'en_cours'): ?>
                        ...
                        <form method="POST" style="margin-top: 15px; text-align: right;"
                              data-confirm="Cet accompagnement sera marqué comme terminé."
