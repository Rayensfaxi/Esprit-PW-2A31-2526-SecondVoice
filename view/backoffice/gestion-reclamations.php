...
<html lang="fr">
  <head>
    ...
    <title>SecondVoice | Gestion des reclamations</title>
      ...
      <main class="page">
        <div class="topbar">
          <div>
            ...
            <h1 class="page-title">Gestion des reclamations</h1>
            <div class="page-subtitle">Traitez les reclamations avec un suivi clair et transparent.</div>
          </div>
          ...
          <section class="hero-banner">
            <div class="hero-inner">
              <div class="hero-copy">
                ...
                <p>
                  Traitez les reclamations avec un suivi clair et transparent.
                </p>
                <a class="cta-button" href="gestion-reclamations.php">Ouvrir une reclamation</a>
              </div>
