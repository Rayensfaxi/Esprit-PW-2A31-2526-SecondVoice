...
<html lang="fr">
  <head>
    ...
    <title>SecondVoice | Gestion des demandes</title>
      ...
      <main class="page">
        <div class="topbar">
          <div>
            ...
            <div class="page-subtitle">Suivez, priorisez et traitez les demandes entrantes.</div>
          </div>
          ...
          <section class="hero-banner">
            <div class="hero-inner">
              <div class="hero-copy">
                ...
                <p>
                  Suivez, priorisez et traitez les demandes entrantes.
                </p>
                <a class="cta-button" href="gestion-demandes.php">Voir les demandes</a>
              </div>
